...
\
**For example:**\
In this first early version, while I’m still building the backend how I want, I added a simple upload form — a human/AI combo. Anyone can use it: just send an email and upload a screenshot or take a photo with your phone.
