...
### 💬 What is [SketchyOrNot](http://SketchyOrNot.com)
...
You can use it to upload a screenshot or even take a photo,  and we’ll run it through our AI tools, then send you back a manual review. It’s not instant, but it’s quick — and it's much better than guessing.

And just so you know that form is here to stay. SketchyOrNot is built to be as **accessible and human-friendly as possible** — for all ages, tech comfort levels, and devices.
